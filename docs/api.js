module.exports = {
	...
	"routes":[
		...
		// blockchain
		{
			...
			"desc":"Returns the current supply of Hypercoin. An estimate using a checkpoint can be returned in 2 cases: on 'slow' devices, and before the UTXO Set snapshot is loaded."
		},
		{
			"category":"blockchain",
		...
		// mempool
		{
			"category":"mempool",
			"url":"/mempool/count",
			"desc":"Returns the number of transactions in Hypercoin Core's mempool."
		},
		{
			"category":"mempool",
			"url":"/mempool/summary",
			"desc":"Returns a summary of Hypercoin Core's mempool (full output from 'getmempoolinfo')",
		...
		// price
		{
			"category":"price",
			"url":"/price",
			"desc":"Returns the price of 1 HRC, in USD, EUR, GBP, and XAU",
			"optionalParams": {
		...
		},
		{
			"category":"price",
			"url":"/price/marketcap",
			"desc":"Returns the market cap of Hypercoin, in USD, EUR, GBP, XAU",
		},
		{
			"category":"price",
			"url":"/price/sats",
		...
		// fun
		{
			"category":"fun",
			"url":"/quotes/all",
			"desc":"Returns the full curated list of Hypercoin quotes.",
		},
		{
			"category":"fun",
			"url":"/quotes/$INDEX",
			"desc":"Returns the Hypercoin quote with the given index from the curated list.",
			"testUrl": "/quotes/0"
		},
		{
			"category":"fun",
			"url":"/quotes/random",
			"desc":"Returns a random Hypercoin quote from the curated list."
		},
		{
			"category":"fun",
			"url":"/holidays/all",
			"desc":"Returns the full curated list of Hypercoin Holidays."
		},
		{
			"category":"fun",
			"url":"/holidays/today",
			"desc":"Returns the Hypercoin Holidays celebrated 'today' (i.e. at the time the API call is made).",
			"optionalParams": {
		...
		},
		{
			"category":"fun",
			"url":"/holidays/$DAY",
			"desc":"Returns the Hypercoin Holidays celebrated on the specified day, using one of the following formats: yyyy-MM-DD, MM-DD.",
